...
CREATE TABLE organization_role (
  ...
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY(role_id),
  UNIQUE KEY uidx_role (organization_id, name)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin AUTO_INCREMENT = 1001;
...
CREATE TABLE organization (
  ...
  UNIQUE KEY uidx_organization (name)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin AUTO_INCREMENT = 1001;
...
CREATE TABLE organization_alert_cond_notification (
  ...
  cache_second INT UNSIGNED NOT NULL DEFAULT 2592000,
...
CREATE TABLE code_gitleaks_repository (
  code_gitleaks_repository_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  code_github_setting_id INT UNSIGNED NOT NULL,
...
CREATE TABLE code_dependency_repository (
  code_dependency_repository_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  code_github_setting_id INT UNSIGNED NOT NULL,
  repository_full_name VARCHAR(255) NOT NULL,
  status ENUM('UNKNOWN', 'OK' ,'CONFIGURED', 'IN_PROGRESS', 'ERROR') NOT NULL DEFAULT 'UNKNOWN',
  status_detail VARCHAR(255) NULL,
...
CREATE TABLE code_codescan_repository (
  code_codescan_repository_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  code_github_setting_id INT UNSIGNED NOT NULL,
  repository_full_name VARCHAR(255) NOT NULL,
  status ENUM('UNKNOWN', 'OK' ,'CONFIGURED', 'IN_PROGRESS', 'ERROR') NOT NULL DEFAULT 'UNKNOWN',
  status_detail VARCHAR(255) NULL,
...
-- AZURE -------------------------------------------------
CREATE TABLE azure_data_source (
  azure_data_source_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  name VARCHAR(64) NOT NULL,
  description VARCHAR(128) NOT NULL,
  max_score FLOAT(5,2) UNSIGNED NOT NULL,
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY(azure_data_source_id)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin AUTO_INCREMENT = 1001;

CREATE TABLE azure (
  azure_id INT UNSIGNED NOT NULL AUTO_INCREMENT,
  name VARCHAR(64) NULL,
  project_id INT UNSIGNED NOT NULL,
  ...
  UNIQUE KEY uidx_azure (project_id, subscription_id)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin AUTO_INCREMENT = 1001;

CREATE TABLE rel_azure_data_source (
  azure_id INT UNSIGNED NOT NULL,
  azure_data_source_id INT UNSIGNED NOT NULL,
  project_id INT UNSIGNED NOT NULL,
  status ENUM('UNKNOWN', 'OK' ,'CONFIGURED', 'IN_PROGRESS', 'ERROR') NOT NULL DEFAULT 'UNKNOWN',
  status_detail TEXT NULL,
  scan_at DATETIME NULL,
  ...
  created_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY(azure_id, azure_data_source_id)
) ENGINE = InnoDB DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_bin;
